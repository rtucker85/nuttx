...
#define EMIOS_PWM_IP_VS_0_PB_CFG_SW_MAJOR_VERSION                3
...
#define EMIOS_PWM_IP_VS_0_I2_CH12_CFG      (2U)
...
extern const Emios_Pwm_Ip_ChannelConfigType Emios_Pwm_Ip_VS_0_I2_Ch12;
